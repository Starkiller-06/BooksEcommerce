        ...
        <div className="flex w-full flex-col items-start justify-center">
          <main className="flex w-[80%] flex-row items-center justify-start gap-12">
            <section className="flex flex-col w-full max-w-[550px] space-y-6 ml-36 justify-center self-center">
              <div>
                <h1 className="text-primary font-montecarlo text-[5.5rem]">
                  Welcome
                </h1>
                <p className="text-foreground">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis
                  bibendum tellus nibh, lacinia dictum mi vestibulum a. Lorem
                  ipsum dolor sit amet, consectetur adipiscing elit. Praesent
                  posuere odio ut metus porta, a ornare purus tempor. Nam nec
                  lorem ut velit finibus congue. Nunc elementum in arcu a
                  eleifend.
                </p>
              </div>
            ...
            <section>
              <h2 className="text-primary">hi</h2>
            </section>
          </main>
        </div>
      </div>
